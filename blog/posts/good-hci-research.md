...
先日の記事「[VR学会が30年を迎えた今、感じること](vr-society-30-years.html)」で、実験をして差を示し、論文にまとめることと、問いに答えることの間には距離がある、と書いた。では、その距離を埋める研究をするにはどうすればいいのか。その後HUMAIでの議論も経て、自分なりに整理がついたので書いておく。HCIでいい研究をする道は三つあると考えている。一つ目は、HCIのパラダイムだからこそ扱える問いに取り組むことである。二つ目は、心理学や認知科学などの問いに、コンピュータを用いてその分野の作法で取り組むことである。三つ目は、アートや当事者による制作、デザイン研究など、既存の枠組みではまだ扱えないものを扱うことである。どの道を選ぶにしても、その研究がどの領域に対するimplicationを持つのかを意識する必要がある。

## HCIの研究が抱える問題

HCIは、人間が使うインタラクティブな計算システムの設計・評価・実装と、それを取り巻く現象を研究する分野として定義されてきた[1]。対象が広いぶん、HCIの研究はサイエンス、工学、デザインといった複数の顔を持ちうる。サイエンスの顔をすれば実験と統計が、工学の顔をすれば性能や実装や汎用性が、デザインの顔をすれば概念や意味や批評性が求められる。どの顔を選んでもよいことは、HCIの強みでもある。一方で、どの顔にもなりきれていない研究も少なくないと感じる。サイエンスとしては作法が足りず、工学としては貢献がはっきりせず、デザインとしては批評性が弱い、という研究である。前回の記事で感じた違和感の一因も、ここにあったと思う。査読者によって読む顔が違うことも、この状況を生む一因かもしれない。サイエンスとして読む査読者は統計の不足を、デザインとして読む査読者は批評性の不足を指摘するので、両方に応えようとした結果、どちらにもなりきれなくなることがある。

稲見昌彦先生は、研究がコンセプトを示すものか、ビジョンを示すものか、現状の問題に取り組むものか、未来に向けたオープンエンドな問いかによって、評価軸を分けていると書いている[2]。その例として稲見先生は石井裕先生のmusicBottlesを挙げ、センシング技術としての新規性は限られていたものの、Tangible Bitsというビジョンを明快に伝えていたと評価している。自分は、この評価軸の分け方を、評価する側だけでなく研究する側も引き受けるべきだと考えている。つまり、自分の研究がどの顔で、どのレイヤーで勝負するのかを先に決め、その顔が求める中身を満たすということである。以下の三つの道は、おおまかに言えば、ビジョンの顔、サイエンスの顔、デザインやアートの顔に対応している。

なお、ここでの三つの道は、研究を分類するための枠組みではなく、論文を書く側が自分の研究をどこに置くのかを決めるためのものである。同じ装置や作品でも、どの道に置くかによって、立てる問いも、返すべきimplicationも変わる。以下で挙げる例も、それぞれの道に置いたときにどう読めるかを示すためのもので、その研究が実際にどう評価されたか、あるいは作り手がどこに置いたつもりだったかとは別の話である。この点は現代アートにも似ている。作品は、作為と無作為のあいだで作られ、作者の手を離れたあとは、作者から独立して評価される。研究も同じで、作り手ができるのは、自分の研究をどこに置くのかを明示することまでであり、それがどう評価されるかは、その先の読み手に委ねられる。

## 1. HCIのパラダイムだからこそ扱える問い

一つ目の道は、他の分野でも扱えるが、HCIで扱うのが最も自然な問いに取り組むことである。暦本純一先生がHuman-AI Integrationとして掲げる、人間とAIがどう統合されうるかという問いは、その一例である[11]。暦本先生は、自身の研究がHCI、Human Augmentation、Human-AI Integrationと展開してきたことを振り返り、その先にある関係を「やや自律性もある、けれども自分の一部でもある、という存在と共存する世界」と表現している。この問いは哲学や認知科学でも扱えるが、実際に作り、使い、そこで人間の側がどう変わるのかを見るという進め方は、HCIの作法によく馴染むと思う。暦本先生の最終講義「Homo Cyberneticus：Human–AI Integrationの時代へ」も、この問いをテーマとしている[35]。何がHCIのパラダイムなのかについては、平城裕隆さんが整理した、HCIが技術について置いている三つの前提が参考になる[45]。技術は重要だが技術だけあっても人は使えるようにならない、という前提。困っている人は困っているので、重要な課題を解くのであれば技術の成熟度は問わず、コモディティ化したものを継ぎはぎにしたものであっても構わない、という前提。そして、現場のユーザーの課題を抽出することが次の技術への貢献になる、という前提である。自分は、一つ目の道の問いがHCIで扱うのに最も自然なのは、これらの前提の上に立っているからだと考えている。人間とAIの統合という問いも、AIの性能だけでは答えが出ず、人がそれをどう使えるようになるのかを問う点で、一つ目の前提に立っている。

<div class="video-embed"><iframe src="https://www.youtube-nocookie.com/embed/-xa-O9BPlaY" title="暦本純一教授 最終講義「Homo Cyberneticus：Human–AI Integrationの時代へ」" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>

暦本先生は、CHI2024を振り返った記事で次のように書いている[3]。

> CHIの大きな物語とは、すなわちダイレクトマニピュレーション(直接操作）時代である。
...
伊藤香織さん、小泉直也先生、苗村健先生によるCoPletは、ミュージアムツアーの参加者とスタッフが録音した声で感想を匿名のまま共有し、参加者は自分の鑑賞体験を反映したリーフレットを持ち帰れるようにするシステムで、日本科学未来館での実験を通して評価されている[13]。ここでは、個人の内側で完結しがちな鑑賞という体験を、その場で他者と共有し、あとから持ち帰れる記録にするというインタラクションが提示されている。Qoloはリハビリテーション工学で、CoPletは博物館学や科学コミュニケーションの分野でも扱える主題である。ただ、装置やシステムを作って実際の生活や展示の場に置き、そこで人の振る舞いや他者との関係がどう変わるのかを見るという進め方は、HCIの作法に近いと思う。

この道の研究の多くは、ビジョンを示す研究になる。そこで求められるのは、作って動かしたときに初めて見える人間の変化を捉えることである。人間の知覚や行為や判断がどう変わるのかは、思考実験だけでは見えにくい。一方で、この道には失敗しやすい点が二つある。一つは評価のすり替えである。GreenbergとBuxtonは、初期段階の発明的な研究にユーザビリティ評価を課すことが、かえって研究を歪めうると指摘した[4]。未来の人間とコンピュータの関係を示す研究で使いやすさの尺度を測っても、ビジョンの価値を示したことにはならない。もう一つは、新しい技術を既存の領域に当てはめただけで終わることである。Arawjoが「LLM Wrapper Papers are Hurting HCI Research」で批判しているように[5]、LLMを使ってみた結果を報告するだけでは、人間とコンピュータの関係について何がわかったのかが残らない。ただし、これは市販の技術を組み合わせること自体の問題ではない。平城さんの二つ目の前提が言うように、重要な課題を解くのであれば技術の成熟度は問われない。問題は、取り組んでいる課題の重要さと、その課題に対する理解の深さのほうにある。

## 2. 他分野の問いを、コンピュータを用いて扱う

二つ目の道は、心理学、脳科学、認知科学などの問いに、コンピュータを用いて正面から取り組むことである。これはサイエンスの顔をする研究であり、心理学のジャーナルに投稿してもおおむね通用する水準にあることが基準になる。コンピュータが加えられるのは、これまで作れなかった実験条件である。たとえばVRでは、身体と視点の関係や、動くことと感じることの関係のように、普段は切り離せないものを操作できる。これは心理学や認知科学にとって、新しい実験パラダイムになりうる。笠原俊一さん、西田惇先生、Pedro Lopes先生の研究はその一例である。彼らは、電気刺激（EMS）で身体を先回りして動かすとき、視覚刺激から160 ms後という時間窓で刺激を与えれば、反応時間を80 ms短縮しながら、ユーザが「自分で動いた」と感じる主体感を保てることを示した[15]。Lopes先生はこの研究を紹介する記事で、EMSがHCIに持ち込まれて10年が経ったいま、外部の力で身体を動かされることは「feels weird」であり、主体感について議論すべきときだと書いている[16]。計算機が人間より先に身体を動かすという条件は、HCIが装置を作るまで存在しなかった。Lopes先生らはこの問いを、EEGやfMRIを用いて脳がどのように感覚情報を統合するのかを調べる研究へと広げており、主体感をめぐる認知科学や神経科学の議論に接続している[16]。
...
ただし、HCIで行われる心理学的な研究には、問いを借りている分野の蓄積を踏まえていないものが多いように見える。心理学であれ脳科学であれ、その現象について何がすでにわかっていて、どの理論が対立しているのかには長い議論の蓄積がある。刺激を与えて質問紙で条件間の傾向を比べるだけで終わると、その分野がすでに知っていることの手前で止まってしまう。問いを借りている分野の論文を読み、議論のどこに自分の研究が入るのかを押さえる必要がある。そうして初めて、自分の結果がどの説明を支持し、どの説明を退けるのかを言えるようになる。この点で気になるのは、HCIの論文がHCIの論文ばかりを引用する傾向が強まっているという報告である[6]。心理学の問いを扱いながらHCIの先行研究しか参照していなければ、心理学ではすでに決着した問題を、別の装置で繰り返すことになりかねない。
...
こうしたポテンシャルが見えやすいのは、作品が先にある体験を成立させ、あとから別の分野がその体験を問いとして扱うようになる場合である。岩田洋夫先生のFloating Eye（2000）は、その一例だと思う。飛行船に取り付けたカメラの映像を、体験者がかぶる広視野のドーム型ディスプレイに映すことで、体験者は自分の身体を上空から見下ろしながら歩くことになる。この作品はArs Electronica 2001などで展示され、岩田先生はその後、2004年にデバイスアート・プロジェクトを立ち上げている[21]。自分の身体を外から見るという体験は、その後、EhrssonやLenggenhagerらが2007年に体外離脱体験を実験的に誘発する研究をScienceに発表したことで、認知神経科学の主題にもなった[22][23]。両者のあいだに直接の影響関係があったかどうかは分からないので、作品が研究を導いたとまでは言えない。言えるのは、研究が問いとして扱うより前に、その体験が作品の中で成立していたということである。

<div class="video-embed"><iframe src="https://www.youtube-nocookie.com/embed/cJmD1DrSvao" title="Floating Eye (VR Lab, University of Tsukuba)" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>

同じような前後関係は、メディアアートの歴史の中にほかにも見つかる。Myron Kruegerは1970年代から、カメラで捉えた人のシルエットがスクリーン上のグラフィックスと反応し合うVIDEOPLACEを制作し、それを「Artificial Reality」と呼んだ[29]。道具を持たずに身体の動きそのものでコンピュータと関わるという体験は、のちにジェスチャ入力や身体を用いたインタラクションとして研究される体験を、時期的に先取りしていた。Char DaviesのOsmose（1995）は、頭部搭載型ディスプレイと、呼吸と身体の傾きを計測するベストを組み合わせ、息を吸うと上昇し、吐くと下降するという仕方で仮想空間を漂う作品である[30]。ここでは、手で操作する代わりに呼吸とバランスで空間を移動するという、身体の内側に近い感覚を使った移動のインタラクションが提示されている。児玉幸子先生と竹野美奈子さんのProtrude, Flow（2001）は、磁性流体を電磁石で制御し、音に合わせて黒い液体が棘のように立ち上がる作品で、岩田先生のデバイスアートの文脈にも位置づけられている[31]。この作品は、素材そのものの振る舞いにこだわった結果として、のちに形状を変えるディスプレイや物質的なインタフェースとして研究される領域と重なる体験を示していたと思う。Floating Eye、VIDEOPLACE、Osmose、Protrude, Flowのいずれも、作品として作り込まれた体験の中に、身体、知覚、素材とインタラクションの関係について、のちに研究が扱うことになる問いが含まれていた。
...
> メディアアート作品に関する研究発表をおこなう場合に，“remotely related ” な「課題」を想定して実験と評価をおこなうよりはむしろ，そのような＜もの＞や＜こと＞ができるようになったことによるインパクトや implication（それが示唆するところ），を語るような発表を見て見たい

この道の研究を評価するときには、無理に設定した課題の達成度よりも、それが示唆するところを見るべきだということである。

この道の研究は、多くの場合デザイン研究として発表される。ただ、HCIでは「デザイン」という言葉が広く使われすぎていて、何でも包めてしまうように感じる。デザイン研究を名乗る以上は、概念、経験、意味、形式、批評性に応える必要がある。まだ問いになっていないものを研究として扱う方法には、Design Spaceのほかに、一人称研究を含む質的研究や、Research through Designのようなデザインリサーチがある。ここではまずDesign Spaceを取り上げ、そのあとで質的研究とデザインリサーチに触れる。

HCIのDesign Spaceという考え方は、工学設計の議論と共通の源を持っている。PahlとBeitzらの工学設計の教科書では、要求を本質的な機能に分解し、機能ごとの解決原理を組み合わせて解の候補を網羅的に作り、そこから技術的・経済的な評価基準で絞り込むという手順が体系化されている[24]。機能と解決原理を表の縦横に並べて組み合わせを列挙する「形態ボックス」は、天文学者Zwickyの形態分析に由来する。HCIでは、CardとMackinlayとRobertsonが入力デバイスのDesign Spaceを論じた際に、このZwickyの形態分析を直接参照し、個々の入力デバイスを、パラメータで定義された空間の中の点として扱った[25][26]。同じ時期にMacLeanらは、設計上の問い（Questions）、その選択肢（Options）、選択肢を比べる基準（Criteria）によって設計の根拠を記述するDesign Space Analysisを提案している[27]。

Cardらの形態分析では、Design Spaceは既存の入力デバイスを分類するためだけでなく、まだ存在しない組み合わせを見つけるための道具として考えられていた。MacLeanらのDesign Space Analysisも、採用されなかった選択肢を含めて設計の空間を記述する点で、実際に作られたもの以外の可能性を扱っている。良い設計空間は、問題を「車か自転車か」という製品の単位で分けずに、「動力、支持、操舵」のような独立した次元に分解するので、既存の製品にない組み合わせが見えるようになる。一方で、近年のHCIでは、既存の論文を体系的にレビューしてコーディングし、そこから次元を抽出する形のDesign Space論文も多い。たとえばLeeらは、執筆支援ツールに関する115本の論文をレビューして、知的で対話的な執筆支援のDesign Spaceを構成している[28]。これは分野の整理として有用だが、次元が既存研究から作られている以上、そこから見えるのは主にすでにあるものの配置である。自分は、Design Spaceという言葉が、未探索の空白を示す道具から、既存研究の分類を指す言葉へと広がってきたことも、「デザイン」が何でも包めてしまう状況の一部だと感じている。その一方で、生成AIの登場によって、Design Spaceを組み合わせの生成に使うという元来の発想が、別の形で戻ってきてもいる。Suhらによる Luminate は、大規模言語モデルを用いて、あるタスクに関わる次元とその値を自動的に生成し、利用者がその空間を探索しながら多様な案を作れるようにするシステムである[32]。ここでのDesign Spaceは、まだ試されていない組み合わせを見つけるための道具として使われている。

質的研究は、インタビューや観察、フィールドノート、作り手自身の記述などを通して、数値に還元しにくい経験や実践を扱う。HCIでも、エスノグラフィやグラウンデッド・セオリー、テーマ分析など、多くの質的な方法が使われてきた[41]。一人称研究はその一つで、研究者自身の身体や経験を一人称の視点から記述する。諏訪正樹先生らは、身体知のように三人称の観察や実験では捉えにくい対象について、研究者自身の一人称の記述を、仮説を生み出す知の営みとして位置づけている[37]。HCIでも、NeustaedterとSengersが、作り手自身が長期間使い続けることで設計の知見を得るautobiographical designを論じている[38]。

海外のHCIでは、質的研究の質をどう担保するかについての議論も蓄積されている。McDonaldとSchoenebeckとForteは、CSCWとHCIの質的研究における評価者間信頼性の扱いを調べ、質的研究に量的研究の信頼性の基準をそのまま持ち込むことの是非を論じたうえで、報告のための指針を示している[42]。また、BraunとClarkeのテーマ分析は、HCIで広く使われる一方で、研究者の解釈と省察（reflexivity）を前提とする方法であるにもかかわらず、テーマがデータから自然に「現れる」かのように書かれたり、その前提と合わない形で評価者間の一致が求められたりすることが指摘されてきた。CHIでも、テーマ分析の使われ方を調べたスコーピングレビューが複数発表されている[43][44]。

Research through Designは、作ることそのものを知を生み出す手段とする立場で、ZimmermanとForlizziとEvensonがHCIの研究方法として定式化した[39]。Gaverは、Research through Designから得られる理論は、検証によって一つに収束するものではなく、暫定的で文脈に依存し、次の設計を生み出すためのものだと論じている[40]。

これらの方法は、いずれも研究、つまり科学的な営みであることを名乗っている。そうである以上、何をもって知が得られたとするのかを議論する必要がある。三人称の実験であれば、再現性や一般化可能性がその基準になる。質的研究やデザインリサーチでは、それらをそのまま当てはめることはできず、上で見たように、省察性や報告の透明性といった別の基準が論じられてきた。自分は、これらの方法で一般化されるのは個々の結果ではなく、次に誰かが試すべき問いや、検討すべき次元や、立てるべき仮説だと考えている。だからこそ、それがどの領域に対するimplicationなのかを明示しなければ、デザインは何でも包める言葉のままになってしまう。

作品のこだわりを研究として示す一つの方法は、Design Spaceの元来の使い方に戻り、そのこだわりがどの次元の上での選択であり、その次元のどこがまだ試されていないのかを示すことだと思う。振動の立ち上がりを調整したという事実だけでは、研究としては読めない。Dourishは、エスノグラフィの価値を設計への示唆の箇条書きで測ることの問題を論じた[9]。作品についても同じことが言え、作ったものの最後に「今後の設計への示唆」を並べるだけでは、作品に凝縮されていたこだわりは言葉にならない。

## implicationを言うために

三つの道に共通して重要なのは、その研究がどの領域に対するimplicationを持つのかを意識することである。一つ目の道では、HCIがこれまで描いてきた人間とコンピュータの関係の構想に対して何を加えるのか、そして現場の課題から次の技術に何を返せるのかが問われる。二つ目の道では、心理学や認知科学の問いに対して、何を支持し何を退けるのかが問われる。三つ目の道では、作品が触れている知覚、身体、社会などの領域に対して、何を示唆するのかが問われる。いずれの場合も、implicationを言うためには、その領域で何がすでに言われているのかを知っていなければならない。自分が見ている限り、最も足りていないのはこの部分である。荒川陸さんは、CHI2024の参加記で次のように書いている[10]。

> 個人が新しい山を次々と造る傾向は問題ではない (=Shared Goal は不要である)が、そのアウトカムが他の分野と接続しきれていないことが課題感としてある

HCIでは研究者がそれぞれ独自の山を造ることが求められるという荒川さんの見方に、自分も同意する。ただ、実際に造られた山の中には、既存の理論を読んでいれば造る必要のなかったものや、隣の分野ではすでに登り終えているものもあると感じる。他の分野と接続できないのは、接続先の理論を読めていないことが大きいのではないか。独自性は、既存の理論を読んだうえで、それでも説明できないところに立ったときに生まれるものだと思う。

## おわりに

最後に、三つ目の道に戻りたい。三つの道のうち、どの領域に対するimplicationを持つのかを言うのが最も難しいのは、三つ目の道である。作品を誠実に作り込もうとするほど、作り手は理由をうまく説明できないまま、素材を選び、動きにこだわり、感触を何度も調整することになる。その判断の一つひとつには、まだ言葉になっていない良さが凝縮されているはずである。作り手自身も説明できないが、それを外すと作品が成立しなくなるものがある。前回の記事では、装置を作る過程そのものが問いを具体化することがある、と書いた。この言語化されていない良さが、どの領域に対するimplicationを持つのかを示すことができれば、それは研究になると考えている。それをどうやって研究の言葉にしていくのかが、これからの自分の問いになりそうだ。
...
11. 暦本純一「[Human Augmentation](https://www.sonycsl.co.jp/worldviews/human-augmentation/)」Sony CSL WORLDVIEWS, 2025.
12. Eguchi, Y., Kadone, H. and Suzuki, K. "Standing Mobility Device With Passive Lower Limb Exoskeleton for Upright Locomotion." *IEEE/ASME Transactions on Mechatronics*, 23(4), pp. 1608–1618, 2018.
13. 伊藤香織, 小泉直也, 苗村健「[CoPlet：感想共有・鑑賞体験記録に基づくミュージアムツアー支援システム](https://doi.org/10.18974/tvrsj.20.2_133)」日本バーチャルリアリティ学会論文誌, 20(2), 2015.
14. Kato, J., Nakano, T. and Goto, M. "TextAlive: Integrated Design Environment for Kinetic Typography." *Proc. CHI 2015*.
...
37. 諏訪正樹, 堀浩一（編）『一人称研究のすすめ：知能研究の新しい潮流』近代科学社, 2015.
38. Neustaedter, C. and Sengers, P. "Autobiographical Design in HCI Research: Designing and Learning through Use-It-Yourself." *Proc. DIS 2012*.
39. Zimmerman, J., Forlizzi, J. and Evenson, S. "Research through Design as a Method for Interaction Design Research in HCI." *Proc. CHI 2007*.
40. Gaver, W. "What Should We Expect from Research through Design?" *Proc. CHI 2012*.
41. Olson, J. S. and Kellogg, W. A. (eds.) *Ways of Knowing in HCI*. Springer, 2014.
42. McDonald, N., Schoenebeck, S. and Forte, A. "[Reliability and Inter-rater Reliability in Qualitative Research: Norms and Guidelines for CSCW and HCI Practice](https://doi.org/10.1145/3359174)." *Proc. ACM on Human-Computer Interaction*, 3(CSCW), 2019.
43. Bowman, R. et al. "[Using Thematic Analysis in Healthcare HCI at CHI: A Scoping Review](https://doi.org/10.1145/3544548.3581203)." *Proc. CHI 2023*.
44. "[Towards Better Reflexive Thematic Analysis in HCI: A Scoping Review of Practice at CHI](https://doi.org/10.1145/3772318.3790417)." *Proc. CHI 2026*.
45. 平城裕隆「[HCI研究の輪郭](https://note.com/hirotakahiraki/n/nb84b8b5f3c75)」note（HCI アドベントカレンダー 2024）, 2024.
